...
<div class="input-group mb-2">
    ...
    <button type="button" id="openModalPickAddressUser" class="btn text-danger fw-normal" data-input="input[name={{$name}}]"
        data-lat="input[name=user_lat]" data-lng="input[name=user_lng]" data-address-detail="input[name=address_detail]"
        data-bs-toggle="modal" data-bs-target="#modalPickAddressUser">@lang('pickAddress')</button>
</div>
