...
<div class="input-group mb-2">
    ...
    <button type="button"
            id="openModalPickEndAddress"
            class="btn text-danger fw-normal"
            data-input="input[name={{$name}}]"
            data-lat="input[name=end_lat]"
            data-lng="input[name=end_lng]"
            data-address-detail="input[name=address_end_detail]"
            data-bs-toggle="modal"
            data-bs-target="#modalPickEndAddress">@lang('pickAddress')</button>
</div>
