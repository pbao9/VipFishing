            ...
            <div class="col-12">
                <div class="mb-3">
                    ...
                    <x-select name="event_id">
                        <x-select-option :option="$userEvents->event_id" value="" title="" />
            ...
            <div class="col-12">
                <div class="mb-3">
                    ...
                    <x-select name="user_id">
                        <x-select-option :option="$userEvents->user_id" value="" title="" />
            ...
            <div class="col-12">
                <div class="mb-3">
                    ...
                    <x-select name="has_reward">
                        <x-select-option :option="$userEvents->has_reward" value="yes" title="yes" />
                        <x-select-option :option="$userEvents->has_reward" value="no" title="no" />
