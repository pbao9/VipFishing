...
namespace App\Admin\DataTables\CommissionHistory;

use App\Admin\DataTables\BaseDataTable;
use App\Admin\Repositories\CommissionHistory\CommissionHistoryRepositoryInterface;
use App\Admin\Traits\GetConfig;

class CommissionHistoryDataTable extends BaseDataTable
{

    use GetConfig;
	
	// ID ( Client ) của bảng DataTable
	protected $nameTable = 'commissionHistoryTable';
    ...
    public function getView(){
        return [
			'amount' => 'admin.commissionHistory.datatable.amount',
			'user_id' => 'admin.commissionHistory.datatable.user',
			'booking_id' => 'admin.commissionHistory.datatable.booking',
            'action' => 'admin.commissionHistory.datatable.action',
        ];
    }
    ...
    protected function setCustomColumns(){
        $this->customColumns = $this->traitGetConfigDatatableColumns('commissionHistory'); // Truyền vào tên bảng trong datatable_columns Config
    }
