...
namespace App\Admin\DataTables\LakeEvents;

use App\Admin\DataTables\BaseDataTable;
use App\Admin\Repositories\LakeEvents\LakeEventsRepositoryInterface;
use App\Admin\Traits\GetConfig;

class LakeEventsDataTable extends BaseDataTable
{

    use GetConfig;
	
	// ID ( Client ) của bảng DataTable
	protected $nameTable = 'lakeEventsTable';
    ...
    public function getView(){
        return [
			'id' => 'admin.lakeEvents.datatable.id',
			
            'action' => 'admin.lakeEvents.datatable.action',
        ];
    }
    ...
    protected function setCustomColumns(){
        $this->customColumns = $this->traitGetConfigDatatableColumns('lakeEvents'); // Truyền vào tên bảng trong datatable_columns Config
    }
