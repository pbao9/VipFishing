...
namespace App\Admin\DataTables\Notifications;
...
class NotificationsDataTable extends BaseDataTable
{
	...
	protected $nameTable = 'notificationsTable';
    ...
    protected function setCustomColumns(){
        $this->customColumns = $this->traitGetConfigDatatableColumns('notifications'); // Truyền vào tên bảng trong datatable_columns Config
    }
	...
	protected function setCustomRawColumns(){
        $this->customRawColumns = ['id', 'action','status','user_id'];
    }
}