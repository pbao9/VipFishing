...
namespace App\Admin\DataTables\Ranks;

use App\Admin\DataTables\BaseDataTable;
use App\Admin\Repositories\Ranks\RanksRepositoryInterface;
use App\Admin\Traits\GetConfig;

class RanksDataTable extends BaseDataTable
{

    use GetConfig;
	
	// ID ( Client ) của bảng DataTable
	protected $nameTable = 'ranksTable';
    ...
    public function getView(){
        return [
			'title' => 'admin.ranks.datatable.title',
			'commission' => 'admin.ranks.datatable.commission',
            'action' => 'admin.ranks.datatable.action',
        ];
    }
    ...
    protected function setCustomColumns(){
        $this->customColumns = $this->traitGetConfigDatatableColumns('ranks'); // Truyền vào tên bảng trong datatable_columns Config
    }
	...
	protected function setCustomEditColumns(){
        ...
        $this->customEditColumns = [
            ...
            'stauts_comission'=>$this->view['commission']
	...
	protected function setCustomRawColumns(){
        $this->customRawColumns = ['title', 'action','stauts_comission'];
    }
}