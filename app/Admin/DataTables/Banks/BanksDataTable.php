...
namespace App\Admin\DataTables\Banks;
...
class BanksDataTable extends BaseDataTable
{
    ...
    protected $nameTable = 'banksTable';
    ...
    {
        $this->customColumns = $this->traitGetConfigDatatableColumns('banks'); // Truyền vào tên bảng trong datatable_columns Config
    }
    ...
    {
        $this->customRawColumns = ['name', 'action', 'logo'];
    }
}